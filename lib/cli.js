...
var nomnom 		= require('nomnom'),
	...
	commands    = require('./cfn-deployer.js');

/**
 * Parse cli options, then call to main
 */
CliParser.parse(nomnom, function(err, command, options) {
	err ? l.error(err) : main(command, options);
});
